...
inventoryRouter.get("/list", authenticateJwt([BasicConstant.ROLE_ADMIN, BasicConstant.ROLE_GUDANG, BasicConstant.ROLE_PRODUKSI, BasicConstant.ROLE_DISTRIBUSI, BasicConstant.ROLE_RETAIL, BasicConstant.ROLE_SUPPLIER]), async (req, res) => {
